...
<div class="items-wrap">
  ...
  <div id="instagram-loaded" class="loaded items unset">
  ...
  <div id="facebook-loaded" class="loaded items unset">
    <nav class="loaded-nav">
  ...
  <div id="uploaded-images" class="items">
    <nav class="mass-change<?php if(empty($images)){ ?> unset<?php } ?> items-naw">
      ...
      <div class="mass-change_action">
        ...
        <div class="count">
          <button data-type="btn minus">-</button>
          <input type="text" name="copy_count" value="1">
          <button data-type="btn plus">+</button>
        </div>
      </div>
    ...
    <div class="items-container">
      <?php if($images){ ?>
          ...
          <div class="item" data-name="<?php echo $image['name']; ?>">
            ...
            <div class="item-actions">
              ...
              <div class="action-group">
                <span class="title"><?php echo $text_count; ?></span>
                <div class="count">
                  <button data-type="minus"><i class="fas fa-minus"></i></button>
                  <input type="text" name="copy_count" value="<?php echo isset($image['count'])?$image['count']:1; ?>">
                  <button data-type="plus"><i class="fas fa-plus"></i></button>
                </div>
              </div>
            </div>
            <div class="price">
        ...
        <?php } ?>
      <?php }else{ ?>
        <p class="empty"><?php $text_empty; ?></p>
      <?php } ?>
    </div>
    <div class="summary">
      <div class="total-box">
...
<script type="text/template" id="loaded-items-instagram">
<% if(items.length > 0){ %>
<% items.forEach(function(item){ %>
<div class="social-item" data-pid="<%=item.id%>" data-url="<%=item.data_url%>" style="background-image:url('<%=item.url%>');">
  <div class="item-inner">
...
<div class="item" data-name="<%=name%>">
  ...
  <div class="item-actions">
    ...
    <div class="action-group">
      <span class="title"><?php echo $text_count; ?></span>
      <div class="count">
        <button data-type="minus" class="btn"><i class="fas fa-minus"></i></button>
        <input type="text" name="copy_count" value="<%=copy_count%>">
        <button data-type="plus" class="btn"><i class="fas fa-plus"></i></button>
      </div>
    </div>
  </div>
  <div class="price">
